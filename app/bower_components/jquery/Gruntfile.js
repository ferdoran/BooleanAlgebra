module.exports = function( grunt ) {
	...
	var distpaths = [
		...
		srcHintOptions = readOptionalJSON("app/.jshintrc");
	...
	grunt.initConfig({
		...
		selector: {
			destFile: "app/selector-sizzle.js",
			apiFile: "app/sizzle-jquery.js",
			srcFile: "app/sizzle/dist/sizzle.js"
		},
		build: {
			all: {
				dest: "dist/jquery.js",
				src: [
					...
					"app/traversing.js",
					"app/manipulation.js",
					{ flag: "wrap", src: "app/wrap.js" },
					{ flag: "css", src: "app/css.js" },
					"app/serialize.js",
					{ flag: "event-alias", src: "app/event-alias.js" },
					{ flag: "ajax", src: "app/ajax.js" },
					{ flag: "ajax/script", src: "app/ajax/script.js", needs: ["ajax"]  },
					{ flag: "ajax/jsonp", src: "app/ajax/jsonp.js", needs: [ "ajax", "ajax/script" ]  },
					{ flag: "ajax/xhr", src: "app/ajax/xhr.js", needs: ["ajax"]  },
					{ flag: "effects", src: "app/effects.js", needs: ["css"] },
					{ flag: "offset", src: "app/offset.js", needs: ["css"] },
					{ flag: "dimensions", src: "app/dimensions.js", needs: ["css"] },
					{ flag: "deprecated", src: "app/deprecated.js" },
		...
		watch: {
			files: [ "<%= jshint.grunt.app %>", "<%= jshint.tests.app %>", "app/**/*.js" ],
			tasks: "dev"
		},
