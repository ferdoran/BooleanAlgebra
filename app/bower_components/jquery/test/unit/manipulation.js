...
test( "clone()", function() {
	...
	div = jQuery("<div/>").html("<embed height='355' width='425' app='http://www.youtube.com/v/3KANI2dpXLw&amp;hl=en'></embed>");
...
test( "html() - script exceptions bubble (#11743)", function() {
	...
	if ( jQuery.ajax ) {
		raises(function() {
			jQuery("#qunit-fixture").html("<script app='data/badcall.js'></script>");
			ok( false, "Exception ignored" );
...
test( "script evaluation (#11795)", function() {
	...
	if ( jQuery.ajax ) {
		...
		jQuery("#qunit-fixture").append( "<script app='" + url("data/test.js") + "'/>" );
...
test( "jQuery._evalUrl (#12838)", function() {
	...
	jQuery("#qunit-fixture").append("<script app='1'/><script app='2'/>");
	...
	jQuery("#qunit-fixture").append("<script app='3'/><script app='4'/>");
