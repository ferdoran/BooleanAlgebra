...
test( "attr(String)", function() {
	...
	$("<script type='jquery/test' app='#5' id='scriptSrc'></script>").appendTo("#qunit-fixture");
	equal( jQuery("#tAnchor5").prop("href"), jQuery("#scriptSrc").prop("src"), "Check for absolute app prop on a script" );
	...
	$img = jQuery("<img style='display:none' width='215' height='53' app='data/1x1.jpg'/>").appendTo("body");
