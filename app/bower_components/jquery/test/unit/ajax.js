...
//----------- jQuery.ajax()
	...
	ajaxTest( "jQuery.ajax() - dataType html", 5, {
		...
		success: function( data ) {
			...
			strictEqual( window["testBar"], "bar", "Check if script app was evaluated for datatype html" );
		}
	});
...
//----------- jQuery.domManip()
	...
	test( "#11264 - jQuery.domManip() - no side effect because of ajaxSetup or global events", 1, function() {
		...
		jQuery("#qunit-fixture").append("<script app='data/evalScript.php'></script>");
...
//----------- jQuery.fn.load()
	...
	asyncTest( "jQuery.fn.load( String, Function ) - check scripts", 7, function() {
		var verifyEvaluation = function() {
			strictEqual( window["testBar"], "bar", "Check if script app was evaluated after load" );
